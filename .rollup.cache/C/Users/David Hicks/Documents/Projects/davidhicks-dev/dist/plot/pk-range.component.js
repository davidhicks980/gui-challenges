 ...
 */
let PkRange = class PkRange extends LitElement {
    constructor() {
        super();
        /**Declarations */
        this.variable = {
    ...
    handleEvent(e) {
        ...
        const output = this.hasRange
            ...
            : target.value;
        target.style.backgroundSize = `${((parseFloat(target.value) - this.min) / (this.max - this.min)) * 100}%, 10%`;
        this.valueLabel.innerText = output.toString();
        this.dispatchEvent(new CustomEvent("shift", {
            detail: {
                symbol: this.symbol,
                value: output,
            },
      ...
      <div class="range-container">
        ...
        <div class="slider-container">
          <input
            ...
            value="${this.value}"
            class="slider"
            style="background-size:${`${((this.value - this.min) / (this.max - this.min)) * 100}%, 10%`}"
...
], PkRange.prototype, "variable", void 0);
__decorate([
    query("#valueLabel"),
    __metadata("design:type", HTMLDivElement)
], PkRange.prototype, "valueLabel", void 0);
__decorate([
    state(),
    __metadata("design:type", Array)
], PkRange.prototype, "stepArray", void 0);
__decorate([
    state(),
    __metadata("design:type", Number)
], PkRange.prototype, "value", void 0);
__decorate([
    state(),
    __metadata("design:type", Boolean)
], PkRange.prototype, "hasRange", void 0);
__decorate([
    state(),
    __metadata("design:type", Number)
], PkRange.prototype, "step", void 0);
PkRange = __decorate([
    customElement("pk-range"),
    __metadata("design:paramtypes", [])
], PkRange);
export { PkRange };
//# sourceMappingURL=pk-range.component.js.map