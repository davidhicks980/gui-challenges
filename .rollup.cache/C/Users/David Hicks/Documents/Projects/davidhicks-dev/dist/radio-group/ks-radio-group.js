...
import { McControl } from "./multiple-choice.component";
...
let KsRadioGroup = class KsRadioGroup extends McControl {
    ...
    static get styles() {
        ...
        input[type="radio"] {
          ...
          height: 100%;
          border-radius: 50%;
          border: 0.16em solid var(--pk-primary);
          outline: none;
          appearance: none;
        ...
        input[type="radio"]:hover:not(:checked):active {
          box-shadow: 0 0 0 0.5em var(--pk-primary--lightest);
        }
        input[type="radio"]:hover:checked {
          box-shadow: 0 0 0 0.4em var(--pk-primary--lightest);
        ...
        input[type="radio"]:active {
          box-shadow: 0 0 0 0.8em var(--pk-primary--lightest);
          background-color: var(--pk-primary--lightest);
...
export { KsRadioGroup };
//# sourceMappingURL=ks-radio-group.js.map