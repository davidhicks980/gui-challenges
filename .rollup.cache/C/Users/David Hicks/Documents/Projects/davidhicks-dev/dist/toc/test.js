    ...
    function (e, t, n) {
        (function (o) {
            ...
            (s = void 0 !== o ? o : this.window || this.global),
                ...
                (l = (function (e) {
                    'use strict';
                    var t, o, l, r = n(2), i = {}, s = {}, c = n(3), a = n(4), u = n(5), d = !!(e &&
                        e.document &&
                            ...
                            (s.init = function (e) {
                                if (d &&
                                    ((i = (function () {
                                        ...
                                        s.destroy(),
                                        null !==
                                            (l = o.selectHeadings(i.contentSelector, i.headingSelector)))) {
                                    var h = o.nestHeadingsArray(l).nest;
                                    i.skipRendering ||
                                        t.render(i.tocSelector, h),
        ...
        e.exports = function (e) {
            ...
            function r(n, o) {
                var l = o.appendChild((function (n) {
                    ...
                    e.listItemClass &&
                        o.setAttribute('class', e.listItemClass);
                    ...
                    return (l.setAttribute('href', e.basePath + '#' + n.id),
                        l.setAttribute('class', e.linkClass +
                            ' node-name--' +
                            n.nodeName +
                            ' ' +
                            e.extraLinkClasses),
            ...
            function i(t) {
                var n = e.orderedList ? 'ol' : 'ul', o = document.createElement(n), l = e.listClass + ' ' + e.extraListClasses;
                return (t &&
                    ((l += ' ' + e.collapsibleClass),
                        (l += ' ' + e.isCollapsedClass)),
                ...
                updateToc: function (r) {
                            ...
                            (function () {
                                ...
                                'auto' === e.fixedSidebarOffset &&
                                    (e.fixedSidebarOffset =
                                        document.querySelector(e.tocSelector).offsetTop),
                                    t > e.fixedSidebarOffset
                                        ? -1 ===
                                            n.className.indexOf(e.positionFixedClass) &&
                                            (n.className +=
                                                ' ' + e.positionFixedClass)
                    ...
                    if (l &&
                        ...
                        t.call(m, function (t) {
                            ...
                            d.nextSibling &&
                                -1 !==
                                    d.nextSibling.className.indexOf(e.isCollapsedClass) &&
                                (d.nextSibling.className =
                                    d.nextSibling.className
                                        .split(' ' + e.isCollapsedClass)
                                        .join('')),
                            (function t(n) {
                                if (-1 !==
                                    n.className.indexOf(e.collapsibleClass) &&
                                    -1 !==
                                        n.className.indexOf(e.isCollapsedClass))
                                    return ((n.className = n.className
                                        .split(' ' + e.isCollapsedClass)
                                        .join('')),
            ...
            return {
                nestHeadingsArray: function (o) {
                    return t.call(o, function (t, o) {
                        ...
                        return (r &&
                            (function (t, o) {
                                for (var r = l(t), i = r.headingLevel, s = o, c = n(s), a = i -
                                    (c ? c.headingLevel : 0); a > 0;)
                                    (c = n(s)) &&
                                        void 0 !== c.children &&
                                        (s = c.children),
                                        a--;
                ...
                'a' !== (i = r.target).tagName.toLowerCase() ||
                    ...
                    (function (e, t) {
                        var n, o, l = window.pageYOffset, r = {
                            ...
                            : e, c = 'function' == typeof r.duration
                            ? r.duration(s)
                            : r.duration;
                        function a(e) {
                            (o = e - n),
