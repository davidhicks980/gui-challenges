...
let HicksSidenav = class HicksSidenav extends LitElement {
    constructor() {
        super();
        this._open = true;
        this._opening = false;
    ...
    createHandler() {
        return {
            ...
            click: (e) => {
                if (this.sidenav) {
                    const targetedElement = e.composedPath()[0];
                    if (!this.sidenav.contains(targetedElement)) {
                        this.close();
                        console.log(this.sidenav.contains(targetedElement), targetedElement);
                    }
                }
            },
        };
...
], HicksSidenav.prototype, "sidenav", void 0);
__decorate([
    property({ type: Boolean })
], HicksSidenav.prototype, "opened", null);
HicksSidenav = __decorate([
