...
import { s as e, f as t } from "./store-1c4b286e.js";
const i = new WeakMap(), s = (e) => (...t) => {
    const e;
    (...t) => ;
    return i.set(n, !0), n;
}, o = (e) => "function" == typeof e && i.has(e), r = "undefined" != typeof window &&
    null != window.customElements &&
    void 0 !== window.customElements.polyfillWrapFlushCallback, a = (e, t, ) => {
    for (; t !== n;) {
        const t, nextSibling;
        e.removeChild(t), (t = n);
    }
}, c = {}, d = {}, l = `{{lit-${String(Math.random()).slice(2)}}}`, h = `\x3c!--${l}--\x3e`, u = new RegExp(`${l}|${h}`);
class p {
    constructor(e, t) {
        (this.parts = []), (this.element = t);
        const [], i = [], s = document.createTreeWalker(t.content, 133, null, !1);
        let o = 0, r = -1, a = 0;
        ...
        for (; a < d;) {
            ...
            if (null !== e) {
                if ((r++, 1 === e.nodeType)) {
                    ...
                    const t = e.data;
                    if (t.indexOf(l) >= 0) {
                        const i = e.parentNode, s = t.split(u), o = s.length - 1;
                        for (let t = 0; t < o; t++) {
                            let n, o = s[t];
                            if ("" === o)
                                 = g();
...
}, f = (e) => -1 !== e.index, g = () => document.createComment(""), m = /([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
class _ {
    constructor(e, t, n) {
        (this.__parts = []),
            (this.template = e),
    ...
    update(e) {
        let t = 0;
        for (constof; this.__parts;)
            void 0 !==  && n.setValue(e[t]), t++;
    ...
    _clone() {
        const e = r
            ...
            : document.importNode(this.template.element.content, !0), t = [];
        this.template.parts,
            i = document.createTreeWalker(e, 133, null, !1);
        let s, o = 0, a = 0, c = i.nextNode();
        for (; o < n.length;)
            if (((s = n[o]), f(s))) {
                for (; a < s.index;)
                    a++,
...
class v {
    ...
    getHTML() {
        ...
        !1;
        for (let i = 0; i < e; i++) {
            const e = this.strings[i], s = e.lastIndexOf("\x3c!--");
...
class y extends v {
    ...
    getTemplateElement() {
        const e = super.getTemplateElement(), t = e.content;
        t.firstChild;
...
const x = (e) => null === e || !("object" == typeof e || "function" == typeof e), S = (e) => Array.isArray(e) || !(!e || !e[Symbol.iterator]);
class k {
    constructor(e, t, n) {
        (this.dirty = !0),
            (this.element = e),
...
class C {
    ...
    __commitTemplateResult(e) {
        ...
        if (this.value instanceof _ && this.value.template === t)
            ...
            const ;
            new _(t, e.processor, this.options),
                i = n._clone();
...
const R = new (class {
    handleAttributeExpressions(e, t, n, i) {
        ...
        if ("@" === s)
            return [new P(e, t.slice(1), i.eventContext)];
        if ("?" === s)
            return [new N(e, t.slice(1), n)];
...
const M = new Map(), $ = new WeakMap(), O = (e, t, n) => {
    let i = $.get(t);
    void 0 === i &&
        (a(t, t.firstChild),
            $.set(t, (i = new C(Object.assign({
                templateFactory: U,
            }, n)))),
            i.appendInto(t)),
        i.setValue(e),
...
const z = (e, ...t) => new v(e, t, "html", R), V = (e, ...t) => new y(e, t, "svg", R);
function D(e, t) {
    const { element: { content:  }, parts: i, } = e, s = document.createTreeWalker(n, 133, null, !1);
    let o = q(i), r = i[o], a = -1, c = 0;
    const d = [];
    let l = null;
    for (; s.nextNode();) {
        a++;
...
const H = (e) => {
    ...
    const document, createTreeWalker;
    (e, 133, null, !1);
    for (; n.nextNode();)
        t++;
    return t;
...
}, W = ["html", "svg"], X = new Set(), J = (e, t, n) => {
    X.add(e);
    const i =  ? n.element : document.createElement("template"), s = t.querySelectorAll("style"), { length: o } = s;
    if (0 === o)
...
n
    ? (function (e, t, ) {
        const { element: { content: i }, parts: s, } = e;
        if (null == n)
        ...
        for (; o.nextNode();)
            for (c++,
                o.currentNode ===  &&
                    ((a = H(t)), n.parentNode.insertBefore(t, n)); -1 !== r && s[r].index === c;) {
                if (a > 0) {
                    for (; -1 !== r;)
                        (s[r].index += a), (r = q(s, r));
                    return;
...
class Y extends HTMLElement {
    ...
    static _propertyValueFromAttribute(e, t) {
        const t, type, i = t.converter || K, s = "function" == typeof i ? i : i.fromAttribute;
        return s ? s(e, n) : e;
    }
    static _propertyValueToAttribute(e, t) {
        if (void 0 === t.reflect)
            return;
        const t, type, i = t.converter;
    ...
    _propertyToAttribute(e, t, Z) {
        const i = this.constructor, s = i._attributeNameForProperty(e, n);
        if (void 0 !== s) {
    ...
    _requestUpdate(e, t) {
        let = !0;
        if (void 0 !== e) {
            const i = this.constructor, s = i._classProperties.get(e) || Z;
    ...
    _enqueueUpdate() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._hasConnected ||
                (yield new Promise((e) => (this._hasConnectedResolver = e)));
            try {
...
Y.finalized = !0;
const ee = "adoptedStyleSheets" in Document.prototype &&
    "replace" in CSSStyleSheet.prototype;
function te(e, t = []) {
    for (let ; 0, i = e.length; )
        ;
    n++;
    {
        const i = e[n];
...
(ie.finalized = !0),
    (ie.render = (e, t, n) => {
        ...
        const i = n.scopeName, s = $.has(t), o = B && 11 === t.nodeType && !!t.host, r = o && !X.has(i), c = r ? document.createDocumentFragment() : t;
        if ((O(e, c, Object.assign({
            templateFactory: j(i),
        }, n)),
            r)) {
            const e = $.get(c);
            $.delete(c);
            const e, value;
             instanceof _ ? e.value.template : void 0;
...
const re = Array.prototype.slice, ae = Element.prototype.matches || Element.prototype.msMatchesSelector, ce = [
    "a[href]",
    "area[href]",
    "input:not([disabled])",
    "select:not([disabled])",
...
function he(e, t, n) {
    if (e.nodeType == Node.ELEMENT_NODE) {
        ...
        if ("content" == n.localName) {
            const e = n, i = e.getDistributedNodes ? e.getDistributedNodes() : [];
            for (let e = 0; e < i.length; e++)
                he(i[e], t);
            return;
        }
        if ("slot" == n.localName) {
            const e = n, i = e.assignedNodes
                ? e.assignedNodes({
                    flatten: !0,
                })
                : [];
...
const pe = new (class {
    ...
    setInert(e, t) {
        if (t) {
            ...
            if ((e.setAttribute("inert", ""),
                ...
                let t = e.parentNode;
                for (; t;)
                    11 === t.nodeType && ue(t), (t = t.parentNode);
            }
        }
        else {
            if (!this._inertRoots.has(e))
    ...
    register(e, t) {
        ...
        return (void 0 !==  ? n.addInertRoot(t) : (n = new le(e, t)),
            this._managedNodes.set(e, n),
            n);
    }
    deregister(e, t) {
        const ;
        this._managedNodes.get(e);
        return n
            ...
            switch (e.type) {
                ...
                case "attributes":
                    if ("inert" !== e.attributeName)
                        return;
                    const t = e.target, i = t.hasAttribute("inert");
                    n.setInert(t, i);
            }
        }, this);
    }
...
document.addEventListener("click", (e) => {
    ...
    (function (e) {
        ...
        arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
            ...
            o = function (e) {
                var e, startTime;
                 ? ((i.value = n), i.entries.push(e)) : (i.isFinal = !0),
                    t();
            },
...
const { loadFirebase: Ue } = _e, Me = Ue("app", "auth", "performance").then(() => window.firebase);
Me.then(function (n) {
    n.initializeApp(t), n.performance();
    let i = () => { }, s = null;
    const o = (t) => {
        let = !1;
        const i = t.data() || {}, o = i.currentUrl || "", { userUrl: r, userUrlSeen: a, activeLighthouseUrl: c } = e.getState();
        if (null !== c)
            ;
        else if (s && s !== o)
             = !0;
...
const $e = (() => {
    let e;
    return () => e || ((e = Ue("firestore").then(() => window.firebase.firestore())), e);
})();
function Oe() {
    return __awaiter(this, void 0, void 0, function* () {
        const t = e.getState();
        if (!t.user)
            return null;
        return (yield $e()).collection("users").doc(t.user.uid);
    });
}
function ze(e, t = null) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!n)
            return null;
        const i = (yield $e()).runTransaction((i) => __awaiter(this, void 0, void 0, function* () {
            const s = (yield i.get(n)).data() || {}, o = {
                currentUrl: e,
...
function Ve() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            e = (yield firebase.auth().signInWithPopup(t)).user;
        }
        catch (e) {
...
function De() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield Me, yield firebase.auth().signOut();
        }
        catch (e) {
...
function qe(e, t = null) {
    return __awaiter(this, void 0, void 0, function* () {
        const window, encodeURIComponent;
        (e);
        let i = `${He}/lh/reports?url=${n}`;
        t && (i += `&since=${t.getTime()}`);
        const s = yield window.fetch(i), o = yield s.json();
        if (!s.ok)
...
const Je = e.action(() => {
...
}), Ke = e.action((t, n) => (() => __awaiter(void 0, void 0, void 0, function* () {
    if (t.activeLighthouseUrl)
        return null;
    e.setState({
        activeLighthouseUrl: n,
        lighthouseError: null,
    });
    const i = yield (function (e, t = !1) {
        return __awaiter(this, void 0, void 0, function* () {
            const { url: e, replace:  };
            !0,
                save;
    ...
    return s;
}))(n, t.isSignedIn), s = new Date(i.auditedOn));
t = e.getState();
const o = await ze(n, s), r = await qe(n, o);
return {
    userUrl: n,
...
Ge = e.action((t, n, i) => (() => __awaiter(void 0, void 0, void 0, function* () {
    const t = yield qe(n, i), { activeLighthouseUrl: s } = e.getState();
    return s
        ? null
        : {
            userUrl: n,
    ...
    Ye = e.action(() => {
        const e = document.querySelector("main"), t = document.querySelector("web-header");
    ...
    nt = e.action(() => ((n["web-accepts-cookies"] = "1"),
        {
            userAcceptsCookies: !0,
            showingSnackbar: !1,
        })),
    it = e.action((e, t) => {
        if (!je.isValidLanguage(t))
            return e;
        return (Xe.set("firebase-language-override", t, {
            expires: 3650,
            samesite: "strict",
        }),
...
customElements.define("web-profile-switcher-container", class extends rt {
    static get properties() {
        return {
...
customElements.define("web-language-select", class extends rt {
    static get properties() {
        return {
            current: {
                type: String,
...
customElements.define("web-side-nav", class extends LitElement {
    ...
    onStateChanged({ currentUrl: t } = {
        currentUrl: null,
    }) {
        const { isSideNavExpanded: n } = e.getState();
        if (n !== this.expanded && ((this.expanded = n), t)) {
            t = ((t = t.replace(/"/g, '\\"')).match(/^\/\w+\//) || [""])[0];
            const e = this.querySelector("[active]"), n = this.querySelector(`[href="${t}"]`);
            if (e === n)
                return;
    ...
    onTransitionEnd() {
        if (((this.animatable = !1), this.expanded_))
            this.focus();
        else {
...
oe("web-snackbar-container{bottom:0;display:block;left:0;margin:0;pointer-events:none;position:fixed;right:0;z-index:300}@media (min-width:481px){web-snackbar-container{margin:8px}}");
customElements.define("web-snackbar-container", class extends se {
    static get properties() {
        return {
            open: {
                type: Boolean,
...
const ht = new WeakMap(), ut = s((e) => (t) => {
    if (!(t instanceof C))
        throw new Error("unsafeHTML can only be used in text bindings");
    const ht, get;
    (t);
    if (void 0 !==  && x(e) && e === n.value && t.value === n.fragment)
        return;
...
function ft() {
    return ((bt =
        bt ||
            (function () {
                return __awaiter(this, void 0, void 0, function* () {
                    const { default: e } = yield import("./algoliasearch-lite.esm.browser-25e885c6.js"), t = "webdev";
...
customElements.define("web-search", class extends se {
    ...
    get hitsTemplate() {
      ...
      `;
        if (!this.hits.length) {
            if (!this.query)
                return "";
            const e = "web.dev " + this.query.trim(), t = "https://google.com/search?q=" + window.encodeURIComponent(e);
            return z `
    ...
    updated(e) {
        e.has("cursor") &&
            (-1 !== this.cursor
                ? this.inputEl.setAttribute("aria-activedescendant", `web-search-popout__link--${this.cursor}`)
    ...
    search(e) {
        return __awaiter(this, void 0, void 0, function* () {
            if (((this.query = e), "" !== e))
                try {
                    const t = yield ft(), { hits:  } = yield t.search(e, {
                        hitsPerPage: 10,
...
export { se as B, He as L, rt as a, Ye as b, st as c, et as d, Ie as e, V as f, Ge as g, z as h, Ke as i, Ve as j, pt as k, ot as o, O as r, oe as s, Pe as t, };
